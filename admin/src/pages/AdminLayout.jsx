    ...
    <div className="flex h-screen bg-[#080C16] text-white font-sans overflow-hidden relative">
      ...
      >
        ...
        <div className="p-3 border-t border-white/5 space-y-2 flex-shrink-0">
          {sidebarOpen && (
            <Link to="/profile" className="flex items-center gap-2.5 px-3 py-2 rounded-xl bg-white/5 hover:bg-white/10 transition-colors">
              <div className="w-7 h-7 rounded-lg bg-gradient-to-br from-blue-500 to-purple-500 flex items-center justify-center text-xs font-bold flex-shrink-0 overflow-hidden">
                {user?.profilePicture ? (
