                            ...
                            {chatMessages.map((msg) => (
                                <div key={msg.id} className={`flex ${msg.sender === 'user' ? 'justify-end' : 'justify-start'}`}>
                                    <div className={`max-w-[80%] p-3 rounded-2xl text-sm ${
                                        ...
                                        <p>{msg.text}</p>
                                        <p className={`text-[10px] mt-1 ${msg.sender === 'user' ? 'text-purple-200' : 'text-gray-400'}`}>{msg.timestamp}</p>
                                    </div>
                                </div>
                            ))}
                            <div ref={chatEndRef} />
                ...
                <div className="relative overflow-hidden rounded-3xl bg-gradient-to-r from-purple-100 to-blue-100 dark:from-purple-900/40 dark:to-blue-900/40 border border-white/20 dark:border-white/10 p-8 backdrop-blur-md shadow-xl dark:shadow-2xl">
                    ...
                    <div className="relative z-10">
                        <h2 className="text-4xl md:text-5xl font-bold mb-4 text-gray-900 dark:text-white">
                            Welcome back, <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-600 to-blue-600 dark:from-purple-400 dark:to-blue-400">{mockData.user.name}</span>!
                        </h2>
