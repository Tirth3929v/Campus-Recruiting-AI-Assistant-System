      ...
      <div className="min-h-screen bg-gray-900 flex flex-col items-center justify-center text-white px-4 text-center">
        <div className="bg-slate-800 p-8 rounded-2xl border border-slate-700 max-w-md">
          ...
          <p className="text-gray-400 text-sm mb-6">
            You are logged in as a <strong>{user.role}</strong>. This portal is for companies only. Please log out and sign in with a company account to access this page.
          </p>
          <button onClick={(e) => {
            e.preventDefault();
            logout();
